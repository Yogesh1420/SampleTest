...
@Component({
  selector: 'app-jp-hall',
  templateUrl: './jp-hall.component.html',
  styleUrls: ['./jp-hall.component.css']
})
export class JpHallComponent implements OnInit {
  bookingForm= new FormGroup({
    hallname:  new FormControl('JP Mini Hall',Validators.required),
...
minDate:any;
  ...
  book(){
    console.log('From jp.comp.ts ' + this.bookingForm);
