...
@Component({
  selector: 'app-msm-hall',
  templateUrl: './msm-hall.component.html',
  styleUrls: ['./msm-hall.component.css']
})
export class MsmHallComponent implements OnInit {
  bookingForm= new FormGroup({
    hallname:  new FormControl('MSM Party Hall',Validators.required),
...
minDate:any;
  ...
  book(){
    console.log('From msm.comp.ts ' + this.bookingForm);
