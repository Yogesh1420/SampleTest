...
@Component({
  selector: 'app-gh-hall',
  templateUrl: './gh-hall.component.html',
  styleUrls: ['./gh-hall.component.css']
})
export class GhHallComponent implements OnInit {
  bookingForm= new FormGroup({
    hallname:  new FormControl('GH mini Hall',Validators.required),
...
minDate:any;
  ...
  book(){
    console.log('From gh.comp.ts ' + this.bookingForm);
