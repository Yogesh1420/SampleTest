...
@Component({
  selector: 'app-dk-hall',
  templateUrl: './dk-hall.component.html',
  styleUrls: ['./dk-hall.component.css']
})
export class DkHallComponent implements OnInit {
  bookingForm= new FormGroup({
    hallname:  new FormControl('DK Wedding Hall',Validators.required),
  ...
  book(){
    console.log('From dk.comp.ts ' + this.bookingForm);
