...
@Component({
  selector: 'app-sg-hall',
  templateUrl: './sg-hall.component.html',
  styleUrls: ['./sg-hall.component.css']
})
export class SgHallComponent implements OnInit {
  bookingForm= new FormGroup({
    hallname:  new FormControl('SG Party Hall',Validators.required),
...
minDate:any;
  ...
  book(){
    console.log('From sg.comp.ts ' + this.bookingForm);
