...
@Component({
  selector: 'app-rk-hall',
  templateUrl: './rk-hall.component.html',
  styleUrls: ['./rk-hall.component.css']
})
export class RkHallComponent implements OnInit {
  bookingForm= new FormGroup({
    hallname:  new FormControl('RK Party Hall',Validators.required),
...
minDate:any;
  ...
  book(){
    console.log('From rk.comp.ts ' + this.bookingForm);
